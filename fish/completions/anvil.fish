...
complete -c anvil -n "__fish_use_subcommand" -s s -l state-interval -d 'Interval in seconds at which the status is to be dumped to disk' -r
complete -c anvil -n "__fish_use_subcommand" -l dump-state -d 'Dump the state of chain on exit to the given file' -r -F
